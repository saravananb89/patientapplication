...
public class Main extends Application {
    ...
    private final static Button actionLogin = new Button("Login");
    private final static Button cancel = new Button("Cancel");
    ...
    public static void loadLoginDialog(Stage primaryStage) {
    ...
    public static void loadStage(Stage primaryStage, Locale locale, boolean opaqueVisible) {
