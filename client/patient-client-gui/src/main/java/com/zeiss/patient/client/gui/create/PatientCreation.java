...
public class PatientCreation extends TextFieldValidation {
    ...
    public void showPatientDialog( Patient patient, Runnable runnable, Stage parentStage
    ){
        loadFxml();
    ...
    private void loadFxml() {
        try {
            ...
            fxmlLoader.setLocation(getClass().getResource("/com/zeiss/patient/client/gui/create/PatientCreate.fxml"));
